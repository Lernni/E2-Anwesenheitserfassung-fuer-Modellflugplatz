...
Zur Zyklusplanung werden Iteration Plans verwendet. Die dort eingefügten Elemente stammen aus dem erstellten GitHub Repository und sind ihrer Priorität nach in der nächsten Iteration zu planen.
...
image::images/project_status/Iteration_2.PNG[]

Iteration 3 
[#img-ip3]
.Fortschritt Iteration 3
image::images/project_status/Iteration_3.PNG[]
