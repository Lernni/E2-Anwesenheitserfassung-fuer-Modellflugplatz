...
Zur Zyklusplanung werden Iterationpläne verwendet. Die dort eingefügten Elemente stammen aus dem erstellten GitHub-Repository und sind ihrer Priorität nach in denb einzelnen Iteration zu planen.
...
* Fertigstellung eines Work Items (Use-Cases) kann und soll nicht innerhalb einer Iteration bewerkstelligt werden (iteratives Arbeiten vertiefen)
