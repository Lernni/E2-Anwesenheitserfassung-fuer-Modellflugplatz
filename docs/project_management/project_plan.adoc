...
Zur Zyklusplanung werden Iteration Plans verwendet. Die dort eingefügten Elemente stammen aus der Datei <<Work Item List>> und sind ihrer Priorität nach in der nächsten Iteration zu planen.
...
|It. Nr. 1
|Inception - Grobübersicht erhalten
|Analyse, Erstbesprechung, Fortbildung
|KW 49-50
|?

|It. Nr. 2
|Elaboration - Weitergehende Entwicklungsschritte
|Weiterentwicklung der Analyse, Start des Entwurfs, Start des Designentwurfs, Use-Case-Entwicklung
|KW 51-53
|?

|It. Nr. 3
|Elaboration - Weitergehende Entwicklungsschritte
|Vorläufige Fertigstellung Analyse & Entwurf
|KW 1-2
|?
