...
Zur Zyklusplanung werden Iteration Plans verwendet. Die dort eingefügten Elemente stammen aus dem erstellten GitHub-Repository und sind ihrer Priorität nach in den einzelnen Iterationen zu planen. Das GitHub-Repository ist unter https://github.com/simonherbstrith/E2-Anwesenheitserfassung-fuer-Modellflugplatz/ zu finden.
