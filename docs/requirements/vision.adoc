...
* in einem vorausgegangenen Projekt (SE-Projekt: "Wetterstation") enstand eine wetterfeste Infrastruktur, die eine Anbindung eines RFID-Readers ermöglichen sollte
