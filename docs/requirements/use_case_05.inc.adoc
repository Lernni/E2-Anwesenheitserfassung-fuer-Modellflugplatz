...
. Sc1.1: Die Daten von *Vereinsmitgliedes A* haben sich verändert und dieses teilt die Änderungen *Administrator B* mit. *Administrator B* meldet sich erfolgreich auf der Webseite an, verändert die `Daten` von *Vereinsmitglied A* und bestätigt die Änderungen. Die Daten von *Vereinsmitglied A* sind nun in der _Datenbank_ aktualisiert.
...
. Sc2: Die Daten von *Vereinsmitgliedes C* haben sich verändert und dieses teilt die Änderungen *Administrator* B mit. *Administrator* B meldet sich erfolgreich auf der Webseite an, verändert die Daten von *Vereinsmitgliedes B* und schließt versehentlich die Webseite. Die Veränderung der `Daten` wird nicht in der _Datenbank_ gespeichert. Die Daten von *Vereinsmitglied A* sind nun in der _Datenbank_ aktualisiert.
