...
//* *NFAF-3*: Auditierung: Sollte das Flugprotokoll eine bestimmte Zeit (länger als 30 min) nicht aktualisiert werden, erhält der Administrator eine entsprechende Information auf dem Webserver
...
** bestehender Webserver soll als Webplatform verwendet werden
