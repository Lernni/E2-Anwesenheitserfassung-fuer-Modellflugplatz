...
** Hinzufügen eines neuen Piloten am Webserver, der dem Terminal erst bekannt gemacht werden muss
** Lokal gehaltene Protokolländerungen am Terminal, müssen den Webserver erreichen. 
