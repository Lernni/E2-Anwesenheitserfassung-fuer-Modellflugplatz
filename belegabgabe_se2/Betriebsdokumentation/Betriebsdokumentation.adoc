...
Es empfielt sich, eine Neuinstallation des Terminals mit `build.sh` zu machen.
Dabei wird die Datenbak gelöscht, es empfielt sich daher, ein Backup anzufertigen
