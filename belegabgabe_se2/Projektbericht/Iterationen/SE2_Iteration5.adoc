...
So konnte die Grundstruktur des Webservers erdacht und der erste Entwurf der Datenbank aufgesetzt werden. Da die Entwickler sich nicht sicher waren, ob SQLite für die Datenbank genutzt werden durfte bzw. vom Kunden gewünscht war, wurde die Weiterarbeit erstmal gestoppt.   
Dennoch konnte am Ende der Iteration bereits eine Verbindung zwischen Backend- und Frontend-Prototyp hergestellt werden. 
...
Obwohl uns der Versand der Hardware bereits im ersten Meeting auf die darauf folgende Woche fest zugesichert wurde, sollten wir fast anderthalb Monate darauf warten. So verzögerte sich unsere Arbeitsplanung nach hinten. 
